  ...
  return (
    <section className="bg-hero min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        {/* Badge */}
        <div
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-hero-border bg-hero-surface mb-8 animate-fade-up"
          style={{ animationDelay: "0ms" }}
        >
          <span className="w-1.5 h-1.5 rounded-full bg-accent" />
          <span className="font-mono text-[11px] text-hero-muted tracking-wide">
            v1.2.2 — open source
          </span>
        </div>
        ...
        {/* Headline */}
        <h1
          className="text-5xl sm:text-6xl font-bold text-hero-tx leading-[1.1] tracking-tight mb-6 animate-fade-up"
        ...
        {/* Subtitle */}
        <p
          className="text-lg text-hero-muted max-w-xl mx-auto leading-relaxed mb-10 animate-fade-up"
        ...
        <div className="animate-fade-up" style={{ animationDelay: "240ms" }}>
          <div className="bg-hero-surface border border-hero-border rounded-xl overflow-hidden max-w-lg mx-auto text-left mb-8">
            ...
            <div className="px-4 py-4 space-y-2">
              ...
              <TerminalLine delay={1200}>
                <span className="font-mono text-xs text-hero-muted">
                  Packages: +3 added (msw, zustand, @withgus/debug, vaul)
                </span>
              </TerminalLine>
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <a
              href="#docs"
              className="px-6 py-2.5 bg-accent text-white font-semibold text-sm rounded-lg hover:opacity-90 transition-opacity"
            >
              Get started
            </a>
            <button
